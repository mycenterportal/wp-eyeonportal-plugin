...
defined('THREEJS_MAP_V1_VERSION')       OR define('THREEJS_MAP_V1_VERSION', '1.1.45');
defined('THREEJS_MAP_V2_VERSION')       OR define('THREEJS_MAP_V2_VERSION', '2.0.12');
...
defined('MCD_API_CENTER_INFO')      OR define( 'MCD_API_CENTER_INFO', '/v1/center/info' );
